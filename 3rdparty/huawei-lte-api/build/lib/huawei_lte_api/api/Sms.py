...
class Sms(ApiGroup):
    ...
    #def get_sms_list(self,
        ...
        #return self._connection.post_get('sms/smsRecivess', OrderedDict((
        #   ('PageIndex', page),
    ...
    #def get_sms_out_list(self,
                     #page: int=1,
                     #box_type: BoxTypeEnum=BoxTypeEnum.LOCAL_SENT,
                     #read_count: int=20,
                     #sort_type: int=0,
                     #ascending: int=0,
                     #unread_preferred: int=0
        ...
        #return self._connection.post_get('sms/sms-listsss', OrderedDict((
        #    ('PageIndex', page),
        #   ('ReadCount', read_count),
